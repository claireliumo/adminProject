<template>
  <div class="area" id="areaElectricity">
    <div class="area-title" @click="expandTable">
      <i class="el-icon-plus" v-if="!isExpand"></i>
      <i class="el-icon-minus" v-else></i>
      {{datas.title}}
    </div>
    <div class="area-content" v-show="isExpand">
      <charts
        v-for="(item,key) in areaElectricity"
...
export default {
  ...
  mounted() {
    $("#areaElectricity").css('height', '820px');
    console.log(this.datas);
     var that = this;
    axios({
      url: this.FACTURL.baseURL+"/energy_overview",
      method: "post",
      data: {
