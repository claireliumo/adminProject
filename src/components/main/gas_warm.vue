<template>
  <div class="indoorhis" id="gasWarm">
    ...
    axios({
      ...
      .then(function (response) {
        ...
        if (response.data.msg == 'success') {
          ...
          that.areaMonthData = [];
          that.areaYearData = [];
          for (var i = 0; i < ans.ac_gas.history_year_list.length; i++) {
            that.xYeardata.push(ans.ac_gas.history_year_list[i].history_time);
            that.areaYearData.push(ans.ac_gas.history_year_list[i].history_value);
          }
          for (var i = 0; i < ans.ac_gas.history_month_list.length; i++) {
            that.xMonthdata.push(ans.ac_gas.history_month_list[i].history_time);
            that.areaMonthData.push(ans.ac_gas.history_month_list[i].history_value);
          }
        }
      })
